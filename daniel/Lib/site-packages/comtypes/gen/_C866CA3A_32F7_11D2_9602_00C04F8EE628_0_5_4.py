...
__all__ = [
    'SPWORDPRONUNCIATIONLIST', 'SVEAllEvents', 'SPPS_Function',
    'DISPID_SPEAudioSizeBytes', 'SAFT12kHz16BitStereo',
    'DISPID_SGRSAddWordTransition', 'eLEXTYPE_PRIVATE4',
    'SpeechRecoProfileProperties', 'SpVoice', 'SPEI_TTS_AUDIO_LEVEL',
    ...
    'eLEXTYPE_RESERVED8', 'DISPID_SPCPhoneToId', 'SPPS_Interjection',
    ...
    'SVP_2', 'DISPID_SRGDictationUnload', 'DISPID_SRDisplayUI',
    'DISPID_SVGetVoices', 'eLEXTYPE_VENDORLEXICON', 'SP_VISEME_1',
    'SPCT_SUB_DICTATION', 'DISPID_SAVolume', 'DISPID_SOTCGetDataKey',
    'SDTAudio', 'SVP_1', 'DISPID_SpeechRecoResultTimes',
    'SRTExtendableParse', 'SREStreamStart', 'SpeechTokenShellFolder',
    'eWORDTYPE_DELETED', 'SVP_3', 'SpeechCategoryAudioOut',
    'DISPID_SBSSeek', 'SVPAlert', 'ISpPhraseAlt',
    'SREPropertyNumChange', 'SPGS_DISABLED',
    'DISPID_SRCERecognitionForOtherContext',
    'SAFTCCITT_ALaw_22kHzMono', 'SAFT44kHz16BitMono', 'ISpAudio',
    'DISPID_SVVolume', 'DISPID_SGRAddResource', 'SAFT48kHz8BitStereo',
    'DISPID_SVSRunningState', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SRCEFalseRecognition', 'SDTPronunciation',
    'SpTextSelectionInformation', 'eWORDTYPE_ADDED', 'DISPID_SAFType',
    'SAFT44kHz16BitStereo', 'SPSEMANTICFORMAT', 'SVP_14',
    'DISPID_SPIReplacements', 'DISPID_SpeechObjectTokens',
    'DISPID_SRRTStreamTime', 'SpeechCategoryAudioIn', 'SINoSignal',
    'SPPS_SuppressWord', 'SPWORDPRONOUNCEABLE', 'SPSERIALIZEDRESULT',
    'SVEStartInputStream', 'SPSNoun', 'SPRST_ACTIVE', '_SPAUDIOSTATE',
    'DISPID_SVSpeakCompleteEvent', 'SDKLCurrentConfig',
    'SPWT_DISPLAY', 'ISpeechObjectToken',
    'DISPID_SRGSetTextSelection', 'ISpeechRecoGrammar',
    'DISPID_SPRuleFirstElement', 'DISPID_SPPEngineConfidence',
    'DISPID_SpeechLexiconProns', 'DISPID_SGRClear', 'SASPause',
    'eLEXTYPE_PRIVATE14', 'SP_VISEME_7', 'SPPHRASEPROPERTY',
    'DISPID_SABIMinNotification', 'SAFT11kHz8BitStereo',
    'DISPID_SLAddPronunciation', 'STCAll', 'SAFT11kHz16BitStereo',
    'DISPID_SDKDeleteValue', 'SVP_16', 'SDA_One_Trailing_Space',
    'DISPID_SVSLastBookmarkId', 'SP_VISEME_15',
    'SGDSActiveWithAutoPause', 'DISPID_SVGetProfiles', 'SGRSTTRule',
    'SpCustomStream', 'SPWT_LEXICAL', 'ISpeechPhraseAlternate',
    'DISPID_SVEWord', 'DISPID_SOTCDefault', 'SREInterference',
    'SFTInput', 'ISpeechRecoResult', 'eLEXTYPE_PRIVATE9',
    'DISPID_SpeechPhraseBuilder', 'SAFT32kHz8BitStereo',
    'SREStateChange', 'SPINTERFERENCE_NOISE',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPAO_RETAIN_AUDIO',
    'SpeechLexiconType', 'SPEI_TTS_PRIVATE', 'SWTDeleted',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SVESentenceBoundary',
    'SDTAlternates', 'SSTTDictation', 'SP_VISEME_21',
    'SDA_Two_Trailing_Spaces', 'SP_VISEME_4', 'DISPID_SVPause',
    'SVF_None', 'SPSHT_OTHER', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SpeechMemoryStream', 'SITooLoud',
    'DISPID_SPPNumberOfElements', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SPRulesCount', 'SPFILEMODE',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SMSGetData',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SRCEHypothesis',
    'DISPID_SLGetPronunciations', 'DISPID_SVAlertBoundary',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'DISPID_SVRate',
    'SPWORD', 'DISPID_SFSClose', 'SVPNormal', 'SREAllEvents',
    'DISPID_SRRGetXMLErrorInfo', 'SWTAdded', 'SASStop',
    'SPEVENTSOURCEINFO', 'SVP_6', 'SPBO_TIME_UNITS', 'ISpProperties',
    'DISPID_SOTCSetId', 'SPPHRASEREPLACEMENT', 'SGRSTTDictation',
    'DISPID_SAFSetWaveFormatEx', 'ISpPhoneticAlphabetSelection',
    'SRCS_Enabled', 'ISequentialStream', '_RemotableHandle',
    ...
    'SPINTERFERENCE_TOOFAST', 'SPRST_NUM_STATES', 'SPPS_Unknown',
    'SPAUDIOBUFFERINFO', 'SPSMF_SAPI_PROPERTIES', 'SPAS_CLOSED',
    'DISPID_SVEventInterests', 'SVP_4', 'SPRECOCONTEXTSTATUS',
    'eLEXTYPE_RESERVED7', 'SAFT22kHz8BitMono',
    'DISPID_SRCEPhraseStart', 'SAFT8kHz8BitStereo',
    'ISpeechPhraseAlternates', 'SPGRAMMARSTATE', 'SPSHT_NotOverriden',
    'SRARoot', 'SAFTNoAssignedFormat', 'SSFMOpenReadWrite',
    'DISPID_SPPName', 'SPEI_PHRASE_START', 'SRADefaultToActive',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SDKDeleteKey',
    'SVP_9', 'SpeechCategoryAppLexicons', 'SRADynamic',
    'SVEAudioLevel', 'SECFIgnoreKanaType', 'SPAR_Unknown',
    'SVEPrivate', 'SPPS_Verb', 'DISPID_SPIEngineId', 'SRTSMLTimeout',
    'DISPID_SASetState', 'DISPID_SAEventHandle', 'DISPID_SOTId',
    'DISPID_SRCEAudioLevel', 'DISPID_SBSWrite', 'SpCompressedLexicon',
    'DISPID_SpeechFileStream', 'SVP_11', 'SSFMCreateForWrite',
    'SP_VISEME_10', 'DISPID_SPRNumberOfElements',
    'SpeechTokenIdUserLexicon', 'DISPID_SPRulesItem',
    'DISPID_SPRDisplayAttributes', 'SPPS_RESERVED2',
    'DISPID_SPEDisplayText', 'SPAS_PAUSE', 'DISPID_SRRGetXMLResult',
    ...
    'DISPID_SLPsItem', 'SRTEmulated', 'SAFTCCITT_uLaw_11kHzStereo',
    'eLEXTYPE_PRIVATE5', 'SVSFlagsAsync', 'STCInprocServer',
    'DISPID_SPEsCount', 'ISpeechCustomStream', 'DISPID_SGRAttributes',
    'DISPID_SpeechPhraseRule', 'SpeechGrammarTagWildcard',
    'DISPID_SPEs_NewEnum', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SOTCategory', 'SpLexicon', 'eLEXTYPE_RESERVED4',
    'DISPID_SRCEEndStream', 'SAFT24kHz8BitMono',
    'DISPID_SVSInputWordPosition', 'ISpeechRecognizer',
    ...
    'DISPID_SpeechMMSysAudio', 'DISPID_SRCEAdaptation',
    'SAFTADPCM_8kHzStereo', 'ISpeechAudioStatus', 'SSFMCreate',
    'DISPID_SPRules_NewEnum', 'ISpeechObjectTokenCategory',
    'DISPID_SPIStartTime', 'DISPID_SVDisplayUI', 'DISPID_SLWWord',
    'SRSEIsSpeaking', 'ISpeechRecoResultDispatch',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SPIAudioSizeBytes', 'SGRSTTWord', 'SAFT12kHz8BitMono',
    'SPPHRASE', 'DISPID_SRCVoice', 'DISPID_SPIRule',
    'eLEXTYPE_PRIVATE20', 'ISpRecognizer3',
    'SPEI_PROPERTY_STRING_CHANGE', 'ISpeechGrammarRules',
    'DISPID_SRCEInterference', 'SAFT24kHz8BitStereo', 'SPLO_STATIC',
    'SRAONone', 'SVP_10', 'SPEI_RECOGNITION', 'SPRECOSTATE',
    'DISPID_SRCEventInterests', 'SPWORDPRONUNCIATION',
    'SECHighConfidence', 'DISPID_SOTRemove', 'SGPronounciation',
    'DISPID_SLPType', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SREmulateRecognition', 'DISPID_SpeechGrammarRules',
    'SVP_7', 'DISPID_SRCEPropertyNumberChange', 'DISPID_SDKEnumKeys',
    'SP_VISEME_5', 'ISpRecoGrammar2', 'SpeechAudioState',
    'SAFT8kHz16BitMono', 'DISPID_SRIsShared', 'DISPID_SRCBookmark',
    'ISpeechRecoResult2', 'DISPID_SGRAddState', 'DISPID_SRGReset',
    ...
    'DISPID_SRGDictationLoad', 'SpMMAudioOut', 'SPEI_TTS_BOOKMARK',
    'SPEI_RESERVED3', 'SAFT16kHz8BitStereo', 'SDA_No_Trailing_Space',
    ...
    'DISPID_SPEsItem', 'ISpDataKey', 'SAFT16kHz16BitStereo',
    'ISpMMSysAudio', 'DISPID_SGRsDynamic',
    'DISPID_SpeechPhoneConverter', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SOTMatchesAttributes',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SRRTTickCount',
    'SVSFDefault', 'SpeechRecognizerState', 'ISpeechPhraseElement',
    'SGRSTTWildcard', 'DISPID_SRCESoundStart',
    'DISPID_SLWPronunciations', 'SRAInterpreter', 'SPCT_DICTATION',
    'DISPID_SRSAudioStatus', 'SpeechStreamSeekPositionType',
    'DISPID_SRCRecognizer', 'DISPID_SpeechRecognizer',
    'SPEI_SR_RETAINEDAUDIO', 'SAFTCCITT_ALaw_44kHzMono',
    'SREHypothesis', 'DISPID_SPIAudioStreamPosition',
    'SPPARTOFSPEECH', 'SpeechAddRemoveWord', 'DISPID_SGRsCommit',
    'DISPID_SVEBookmark', 'SAFT22kHz16BitMono',
    ...
    'SpeechWordPronounceable', 'eLEXTYPE_RESERVED6', 'ISpNotifySink',
    'DISPID_SRRTimes', 'DISPID_SASNonBlockingIO', 'SPAR_High',
    'DISPID_SWFEBitsPerSample', 'DISPID_SRRAudio', 'SPEI_ADAPTATION',
    'DISPID_SVESentenceBoundary', 'SPEI_VISEME',
    'ISpeechLexiconPronunciation', 'SPEI_SR_PRIVATE',
    'SAFTADPCM_22kHzStereo',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SWPKnownWordPronounceable', 'SPBINARYGRAMMAR', 'SVP_5',
    'DISPID_SRGCmdLoadFromResource', 'eLEXTYPE_PRIVATE17',
    'DISPID_SRSNumberOfActiveRules', 'SpeechRegistryUserRoot',
    'SAFT8kHz16BitStereo', 'ISpeechRecognizerStatus',
    'ISpResourceManager', 'SAFTTrueSpeech_8kHz1BitMono',
    'eLEXTYPE_PRIVATE7', 'SAFT11kHz8BitMono', 'SPRS_INACTIVE',
    'ISpeechMemoryStream', 'DISPID_SRGCmdSetRuleIdState',
    'SPPS_Noncontent', 'SGRSTTEpsilon', 'DISPID_SVEStreamStart',
    'ISpeechTextSelectionInformation', 'SpMMAudioIn',
    'DISPID_SRRTLength', 'DISPID_SRRRecoContext', 'SPAR_Low',
    'ISpRecognizer', 'DISPID_SRGCmdLoadFromMemory',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SRCERequestUI',
    'SAFTCCITT_uLaw_44kHzMono', 'SAFT48kHz16BitStereo',
    'SPEI_END_SR_STREAM', 'DISPID_SRIsUISupported',
    'SVSFParseAutodetect', 'ISpRecoResult', 'SPLO_DYNAMIC',
    'DISPID_SRStatus', 'SRSEDone', 'DISPID_SWFEChannels',
    'eLEXTYPE_RESERVED9', 'ISpeechVoiceStatus', 'ISpeechFileStream',
    'ISpeechDataKey', 'DISPID_SGRSTsCount', 'ISpeechAudioFormat',
    'DISPID_SPPFirstElement', 'ISpeechLexiconWord', 'ISpeechLexicon',
    'SpeechAudioFormatGUIDWave', 'SAFT32kHz16BitMono',
    'SRERecognition', 'SPEI_PHONEME',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SpeechCategoryPhoneConverters', 'SAFT22kHz8BitStereo',
    'DISPID_SPPParent', 'DISPID_SASCurrentDevicePosition',
    'SREStreamEnd', 'LONG_PTR', 'SVP_12', 'SpObjectToken',
    'SpStreamFormatConverter', 'SP_VISEME_12', 'DISPID_SPPId',
    'SpeechRecoEvents', 'DISPID_SVSLastBookmark',
    'SPEI_WORD_BOUNDARY', 'DISPID_SDKGetStringValue',
    'ISpeechPhraseProperty', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SpeechVoice', 'DISPID_SpeechPhraseElements',
    'SPINTERFERENCE_TOOSLOW', 'STCInprocHandler', 'SPVPRI_ALERT',
    'SPDKL_CurrentConfig', 'eLEXTYPE_PRIVATE11',
    'DISPID_SRCESoundEnd', 'ISpeechLexiconWords',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SVStatus',
    'SAFT48kHz16BitMono', 'DISPID_SpeechObjectToken', 'SP_VISEME_14',
    'DISPID_SASFreeBufferSpace', 'SpeechLoadOption', 'DISPID_SVSpeak',
    'ISpeechPhraseInfo', 'SpeechRuleState', 'SPSHT_Unknown',
    'eLEXTYPE_PRIVATE1', 'DISPID_SPPsCount', 'SAFT24kHz16BitStereo',
    'SPVPRI_NORMAL', 'ISpObjectWithToken', 'SPCT_SLEEP',
    'SVF_Emphasis', 'SSSPTRelativeToEnd',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPEI_MAX_TTS',
    'SpeechAudioFormatType', 'SVEBookmark', 'DISPID_SABIBufferSize',
    'SPCT_COMMAND', 'DISPID_SLGetWords', 'DISPID_SPRsItem',
    'SPEI_START_INPUT_STREAM', 'DISPID_SLPPartOfSpeech',
    'ISpeechBaseStream', 'SpeechStreamFileMode', 'DISPID_SRCState',
    'DISPID_SpeechPhraseReplacements', 'SPAUDIOSTATE',
    'ISpRecoCategory', 'SDKLDefaultLocation', 'SVP_19',
    'SVSFNLPSpeakPunc', 'SpeechDataKeyLocation', 'SAFTDefault',
    'SpUnCompressedLexicon', 'IEnumString', 'DISPID_SRCRetainedAudio',
    'SPEI_RESERVED6', 'SVSFIsNotXML', 'ISpEventSink',
    'SpPhraseInfoBuilder', 'ISpRecognizer2',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SpeechRecoResult2',
    'SGLexical', 'SPAS_STOP', 'DISPID_SDKSetStringValue',
    'SPPS_NotOverriden', 'SGLexicalNoSpecialChars', 'SPAR_Medium',
    'SpeechGrammarTagDictation', 'eLEXTYPE_PRIVATE2',
    'DISPID_SpeechPhraseProperty', 'DISPID_SPRuleParent',
    'Speech_Default_Weight', 'DISPID_SPCLangId',
    'SpeechTokenKeyAttributes', 'eLEXTYPE_PRIVATE6',
    'SWPUnknownWordUnpronounceable', 'SVSFIsXML', 'SPSInterjection',
    'ISpStream', 'SAFTText', 'UINT_PTR', 'SP_VISEME_18',
    'DISPID_SRSSupportedLanguages', 'DISPID_SpeechLexicon',
    'DISPID_SVIsUISupported', 'SPINTERFERENCE_NONE',
    'SpeechTokenKeyUI', 'DISPID_SLPsCount', 'DISPID_SRRecognizer',
    'SpInProcRecoContext', 'SPEI_UNDEFINED', 'eLEXTYPE_PRIVATE8',
    'DISPID_SRAudioInputStream', 'DISPID_SASState',
    'SRSInactiveWithPurge', 'SLTUser', 'SRESoundStart',
    'DISPID_SOTCreateInstance', 'SPEI_RESERVED2', 'DISPID_SRCPause',
    'SpMemoryStream', 'SPRULESTATE', 'SPSFunction',
    'SAFTCCITT_uLaw_22kHzMono', 'SpeechInterference',
    'DISPID_SWFEExtraData', 'SREPhraseStart', 'SPEI_MAX_SR',
    'DISPID_SVSLastResult', 'DISPID_SPARecoResult',
    'DISPID_SCSBaseStream', 'DISPID_SPIElements',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPEI_RECO_STATE_CHANGE',
    'SP_VISEME_17', 'DISPID_SBSRead', 'SGDSActive', 'SPVISEMES',
    'DISPID_SPRText', 'SPPHRASEELEMENT', 'SPRST_ACTIVE_ALWAYS',
    'SVSFVoiceMask', 'ISpeechMMSysAudio', 'DISPID_SDKGetlongValue',
    'SPLOADOPTIONS', 'DISPID_SGRSTPropertyName',
    'DISPID_SRRSaveToMemory', 'DISPID_SPAsCount', 'SpWaveFormatEx',
    'DISPID_SVSPhonemeId', 'DISPIDSPRG', 'DISPID_SpeechDataKey',
    'ISpeechPhoneConverter', 'ISpeechPhraseReplacement',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPEI_SOUND_START',
    'DISPID_SRGetRecognizers', 'SPSERIALIZEDPHRASE', 'SP_VISEME_0',
    'SpeechUserTraining', 'DISPID_SGRName',
    'DISPID_SLGetGenerationChange', 'DISPID_SPEEngineConfidence',
    'SASRun', 'DISPID_SOTDataKey', 'SpeechAudioVolume',
    'DISPID_SRCSetAdaptationData', 'SPPS_RESERVED1',
    ...
    'SpInprocRecognizer', 'SPINTERFERENCE_NOSIGNAL',
    'SRSActiveAlways', 'DISPID_SLWType', 'SPEI_RESERVED1',
    'DISPID_SPEPronunciation', 'SpeechPartOfSpeech',
    'DISPID_SRGCmdLoadFromObject', 'SP_VISEME_3', 'DISPIDSPTSI',
    'DISPID_SLWs_NewEnum', 'DISPID_SLWsCount',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SRAudioInput',
    'SPAUDIOOPTIONS', 'ISpeechAudio', 'SpPhoneConverter',
    'DISPID_SMSSetData', 'ISpNotifySource', 'SECFNoSpecialChars',
    '_ISpeechVoiceEvents', 'SpeechEngineProperties',
    'SAFTCCITT_uLaw_44kHzStereo', 'SpShortcut', 'SP_VISEME_19',
    'SPINTERFERENCE_TOOQUIET', 'SPGS_ENABLED', 'SGSExclusive',
    'DISPID_SLPs_NewEnum', 'SPPS_Noun',
    'DISPID_SpeechPhraseAlternates', 'WAVEFORMATEX',
    'DISPID_SRProfile', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SPRuleId', 'SINoise', 'SAFT32kHz16BitStereo',
    'DISPID_SpeechXMLRecoResult', 'SECFIgnoreWidth', 'SVP_17',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SpeechLexiconWords',
    'DISPID_SPPsItem', 'SPEI_MIN_TTS', 'SP_VISEME_13',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SABufferInfo',
    'eLEXTYPE_PRIVATE19', 'SRCS_Disabled', 'DISPID_SDKOpenKey',
    'DISPID_SGRSRule', 'DISPID_SVResume', 'DISPID_SRRAudioFormat',
    'DISPID_SMSALineId', 'DISPID_SLPSymbolic', 'DISPID_SGRsAdd',
    'DISPID_SpeechPhraseRules', 'ISpeechRecoResultTimes',
    'SpeechRegistryLocalMachineRoot', 'SPDKL_LocalMachine',
    'SAFTGSM610_11kHzMono', 'SPSSuppressWord',
    ...
    'SPVPRIORITY', 'SPEI_SR_AUDIO_LEVEL', 'Speech_Max_Pron_Length',
    'DISPID_SGRId', 'SpeechWordType', 'DISPID_SGRSAddRuleTransition',
    'SVEWordBoundary', 'DISPID_SPAs_NewEnum', 'eLEXTYPE_PRIVATE12',
    'ISpeechPhraseReplacements', 'DISPID_SGRSTType', 'SITooQuiet',
    'SpSharedRecoContext', 'SpeechGrammarWordType',
    'SPCT_SUB_COMMAND', 'DISPID_SRGRules', 'DISPID_SPPValue',
    'DISPID_SVSInputWordLength', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SWFEBlockAlign', 'Speech_StreamPos_RealTime',
    'SPDATAKEYLOCATION', 'SPVOICESTATUS', 'SPCATEGORYTYPE', 'SBONone',
    'SPEI_INTERFERENCE', 'DISPID_SOTCId', 'SVSFParseSapi',
    'SpMMAudioEnum', 'SPSHORTCUTTYPE', 'ISpeechPhraseElements',
    'SP_VISEME_6', 'DISPID_SRSetPropertyString', 'SPSModifier',
    'SITooSlow', 'SpeechRetainedAudioOptions',
    'DISPID_SRSetPropertyNumber', 'SPRST_INACTIVE', 'SPPROPERTYINFO',
    ...
    'SpeechRuleAttributes', 'SBOPause', 'ISpeechXMLRecoResult',
    'SPSMF_UPS', 'SECFEmulateResult', 'SPPS_RESERVED3',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SpeechGrammarState',
    'ISpeechWaveFormatEx', 'ISpeechPhraseRule', 'SpSharedRecognizer',
    'SPRECORESULTTIMES', 'DISPID_SWFESamplesPerSec',
    'SPDKL_DefaultLocation', 'DISPID_SPIGetDisplayAttributes',
    'ISpStreamFormat', 'DISPID_SMSADeviceId', 'SPEVENTENUM', 'SVP_13',
    'DISPID_SGRSTransitions', 'DISPID_SpeechRecoContext',
    'DISPID_SPERequiredConfidence', 'SPSEMANTICERRORINFO',
    'SP_VISEME_8', 'SPSHORTCUTPAIR', 'DISPID_SRGRecoContext',
    'SAFT32kHz8BitMono', 'DISPID_SLPLangId', 'SPRS_ACTIVE',
    'SAFT8kHz8BitMono', 'SpAudioFormat', 'DISPID_SLWsItem',
    'IInternetSecurityManager', 'SPADAPTATIONRELEVANCE',
    'SP_VISEME_16', 'SPRULE', 'SP_VISEME_2',
    'SpeechPropertyAdaptationOn', 'SVP_21', 'SGRSTTTextBuffer',
    'SPEI_RESERVED5', 'SINone', 'SSFMOpenForRead',
    'SpNullPhoneConverter', 'DISPID_SPPConfidence',
    'DISPID_SGRSTNextState', 'DISPID_SPERetainedStreamOffset',
    'SPBO_PAUSE', 'ISpRecoContext', 'ISpObjectToken',
    'DISPID_SVEVoiceChange', 'SPFM_CREATE', 'SGSDisabled',
    'DISPID_SVEEnginePrivate', 'SAFT16kHz16BitMono', 'SRESoundEnd',
    'DISPID_SPPChildren', 'SpeechRecognitionType',
    'SPEI_START_SR_STREAM', 'DISPID_SVSInputSentenceLength',
    'SPVPRI_OVER', 'DISPID_SRCERecognizerStateChange',
    'SVSFParseSsml', 'DISPID_SRRSpeakAudio', 'SRERequestUI',
    'SREPrivate', 'SpeechDictationTopicSpelling', 'DISPID_SBSFormat',
    'SpeechVisemeFeature', 'SpeechCategoryRecoProfiles',
    ...
    'SPWF_SRENGINE', 'SVEViseme', 'SAFTADPCM_22kHzMono',
    'SDTReplacement', 'SRTStandard', 'ISpStreamFormatConverter',
    'DISPID_SABIEventBias', 'SITooFast', 'SPWAVEFORMATTYPE',
    'SPWORDTYPE', 'tagSTATSTG', 'SPWF_INPUT', 'SP_VISEME_9',
    'ISpeechPhraseInfoBuilder', 'SPSUnknown', 'DISPID_SRGCommit',
    'SSSPTRelativeToStart', 'SPCS_DISABLED', 'SPCS_ENABLED',
    'DISPID_SLWLangId', 'SPPS_LMA', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SRGetFormat',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPWT_PRONUNCIATION', 'DISPID_SGRsCount', 'SPSHT_EMAIL',
    'ISpRecoContext2', 'DISPID_SpeechAudioFormat', 'DISPID_SAFGuid',
    'SECFDefault', 'SpeechRecoContextState',
    'ISpeechGrammarRuleState', 'SVF_Stressed', 'SAFTADPCM_8kHzMono',
    ...
    'DISPID_SpeechWaveFormatEx', 'SAFT22kHz16BitStereo',
    'ISpShortcut', 'SAFTCCITT_ALaw_8kHzMono', 'SDTDisplayText',
    'SECNormalConfidence', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SPEI_SR_BOOKMARK', 'DISPID_SpeechRecoResult',
    'DISPID_SPEDisplayAttributes', 'DISPID_SGRs_NewEnum',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SFSOpen',
    'SVSFNLPMask', 'DISPID_SOTCEnumerateTokens', 'DISPID_SpeechAudio',
    'SPTEXTSELECTIONINFO', 'SVP_0', 'DISPID_SVVoice',
    'SAFTADPCM_44kHzStereo', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SGRSTs_NewEnum', 'ISpVoice', 'SPRECOGNIZERSTATUS',
    'DISPID_SOTSetId', 'STSF_LocalAppData',
    'DISPID_SRCVoicePurgeEvent', 'eLEXTYPE_APP',
    'SAFTCCITT_ALaw_11kHzMono', 'SAFTCCITT_ALaw_44kHzStereo',
    'SpeechRunState', 'IEnumSpObjectTokens', 'DISPID_SOTDisplayUI',
    'DISPID_SpeechVoiceEvent', 'DISPID_SpeechGrammarRule', 'SPSLMA',
    'DISPID_SpeechAudioStatus', 'DISPID_SVWaitUntilDone',
    'DISPID_SPRuleChildren', 'SAFT11kHz16BitMono',
    'DISPID_SRCreateRecoContext', 'SPXRO_Alternates_SML',
    'SPINTERFERENCE', 'SAFTGSM610_8kHzMono', 'ISpLexicon',
    'SpeechAudioFormatGUIDText', 'SVEPhoneme',
    'SAFTExtendedAudioFormat', 'DISPID_SpeechAudioBufferInfo',
    'SDTRule', 'DISPID_SDKGetBinaryValue', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SLPPhoneIds', 'SP_VISEME_11', 'DISPID_SPIAudioSizeTime',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SpeechRecoContextEvents',
    'SLOStatic', 'SPAS_RUN', 'ISpXMLRecoResult', 'SSTTTextBuffer',
    'DISPID_SPRsCount', 'ISpeechGrammarRule',
    'DISPID_SpeechPhraseElement', 'SVP_18', 'SPSVerb',
    'SPXMLRESULTOPTIONS', 'DISPID_SVSkip', 'SDKLLocalMachine',
    'SpResourceManager', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SRCCmdMaxAlternates', 'ISpeechLexiconPronunciations',
    'SpeechVisemeType', 'SAFT12kHz8BitStereo',
    'SpeechPropertyComplexResponseSpeed', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SpeechAllElements',
    'SVSFUnusedFlags', 'DISPID_SpeechRecognizerStatus', 'SRSInactive',
    'SpeechDisplayAttributes', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SVGetAudioOutputs', 'SRAExport',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SpeechPhraseInfo',
    'SPEI_HYPOTHESIS', 'SASClosed', 'DISPID_SOTs_NewEnum',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SGRsFindRule',
    'DISPID_SVPriority', 'DISPID_SPACommit',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SRCResume', 'DISPID_SLGenerationId', 'IStream',
    'STCLocalServer', 'SSTTWildcard', 'DISPID_SOTGetStorageFileName',
    'SVEVoiceChange', 'eLEXTYPE_PRIVATE13', 'SPWORDLIST',
    'SpObjectTokenCategory', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SP_VISEME_20', 'SPRST_INACTIVE_WITH_PURGE', 'SpeechDiscardType',
    'DISPID_SpeechCustomStream', 'SpNotifyTranslator',
    'STSF_FlagCreate', 'ISpeechPhraseProperties', 'DISPID_SRGState',
    'DISPID_SADefaultFormat', 'SPFM_OPEN_READONLY', 'STCRemoteServer',
    'SpeechTokenContext', 'SDTProperty', 'DISPID_SVEPhoneme',
    'SVP_20', 'DISPIDSPTSI_SelectionOffset', 'Speech_Max_Word_Length',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPEI_MIN_SR', 'SPCONTEXTSTATE',
    'ISpRecoGrammar', 'SRAImport', 'SpeechVoicePriority',
    'DISPID_SRRSetTextFeedback', 'DISPID_SRCRequestedUIType',
    'DISPID_SPEAudioSizeTime', 'SVP_8', '_ISpeechRecoContextEvents',
    'DISPID_SVAudioOutput', 'SVSFPersistXML', 'SPEI_SOUND_END',
    'SPEI_REQUEST_UI', 'DISPID_SPRs_NewEnum',
    'DISPID_SRCEStartStream', 'SPEI_SENTENCE_BOUNDARY', 'SPXRO_SML',
    'SVPOver', 'SAFTADPCM_44kHzMono', 'DISPIDSPTSI_ActiveLength',
    'SpeechEngineConfidence', 'SRTReSent', 'DISPID_SPISaveToMemory',
    'SREAudioLevel', 'SDTLexicalForm', 'SpStream', 'SRTAutopause',
    'DISPID_SOTsCount', 'DISPIDSPTSI_SelectionLength', 'STSF_AppData',
    ...
    'SpeechTokenKeyFiles', 'SVSFIsFilename', 'SFTSREngine',
    'SPBO_NONE', 'DISPID_SRGetPropertyString', 'STSF_CommonAppData',
    'DISPID_SPELexicalForm', 'DISPID_SRRPhraseInfo',
    'DISPID_SPPs_NewEnum', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SVSpeakStream', 'SpeechVoiceEvents',
    'DISPID_SpeechLexiconWord', 'DISPID_SpeechPhraseAlternate',
    'SLODynamic', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SGDisplay', 'DISPID_SRCEEnginePrivate', 'DISPID_SRCEBookmark',
    'SPFM_OPEN_READWRITE', 'eLEXTYPE_PRIVATE18', 'SAFT24kHz16BitMono',
    'SDTAll', 'SPBO_AHEAD', 'SPFM_CREATE_ALWAYS', 'SVSFParseMask',
    'SAFT48kHz8BitMono', 'DISPID_SGRSTsItem', 'SPAO_NONE',
    'SVSFPurgeBeforeSpeak', 'SpeechEmulationCompareFlags',
    'SGSEnabled', 'DISPID_SRGDictationSetState',
    'SPEI_END_INPUT_STREAM', 'SRSActive',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SECFIgnoreCase',
    'SPGS_EXCLUSIVE', 'DISPID_SPEActualConfidence', 'SPPHRASERULE',
    'SpFileStream', 'SREBookmark', 'SPEVENT', 'ISpSerializeState',
    'SRAORetainAudio', 'DISPID_SVSCurrentStreamNumber',
    'SDKLCurrentUser', 'DISPID_SRCCreateGrammar',
    'DISPID_SPILanguageId', 'DISPID_SPIGrammarId',
    'eLEXTYPE_PRIVATE16', 'DISPID_SRGetPropertyNumber',
    'SPEI_FALSE_RECOGNITION', 'ISpPhrase',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'eLEXTYPE_USER', 'SPPS_RESERVED4',
    'SpeechSpecialTransitionType', 'SpeechMicTraining',
    'DISPID_SRSCurrentStreamPosition', 'SVP_15', 'SPLEXICONTYPE',
    'SAFT44kHz8BitMono', 'SPSHORTCUTPAIRLIST', 'DISPID_SGRsItem',
    'ISpeechObjectTokens', 'DISPID_SpeechGrammarRuleState',
    'SREFalseRecognition', 'SpeechFormatType', 'tagSPPROPERTYINFO',
    'SPPS_Modifier', 'DISPID_SVEViseme', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SOTIsUISupported', 'Speech_StreamPos_Asap',
    'DISPID_SVEStreamEnd', 'SpeechBookmarkOptions', 'DISPID_SAStatus',
    'eLEXTYPE_RESERVED10', 'SPFM_NUM_MODES', 'SVEEndInputStream',
    'DISPID_SABufferNotifySize', 'DISPID_SPIRetainedSizeBytes',
    ...
    'DISPID_SRRAlternates', 'DISPID_SGRSTRule', 'SLTApp',
    'eLEXTYPE_PRIVATE3', 'ISpeechAudioBufferInfo', 'SREAdaptation',
    'DISPID_SPIGetText', 'SAFT44kHz8BitStereo',
    'IInternetSecurityMgrSite'
]

_check_version('1.1.14', 1617978098.563264)
